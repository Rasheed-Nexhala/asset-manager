  ...
  return (
    ...
    >
      <View className="gap-4 px-4 py-4">
        ...
        {/* Steel Master Selector - Only show in create mode, hide for Fuel type */}
        {mode === 'create' && formData.type !== 'fuel' && (
          <View className="border-2 border-dashed border-[#1E40AF] rounded-[10px] bg-[#1E40AF]/5 p-4">
            <Text className="text-[17px] font-semibold text-[#0F172A] mb-2">
              Create from Steel Master (Optional)
            </Text>
            <Text className="text-[13px] text-[#64748B] mb-3">
              Select a steel master to auto-fill item details
            </Text>
            ...
            {selectedSteelMaster && (
              <View className="mt-3 bg-white rounded-[10px] p-3 border border-[#E2E8F0]">
                <Text className="text-[13px] text-[#64748B] mb-1">Selected Steel Master:</Text>
        ...
        {mode === 'create' && (
          <View className="gap-1.5">
            ...
            {isFromSteelMaster && autoGeneratedSku && selectedSteelMaster && (
              <Text className="text-[13px] text-[#64748B]">
                From Steel Master: {selectedSteelMaster.name} (editable)
              </Text>
            )}
            {errors.sku && (
              <Text className="text-[13px] text-[#DC2626]" accessibilityLiveRegion="polite">
        ...
        {mode === 'create' && (
          <View className="gap-1.5">
            <UnitSelector
              ...
              autoFilledFrom={formData.type === 'fuel' ? 'Fuel type' : 'Steel Master default'}

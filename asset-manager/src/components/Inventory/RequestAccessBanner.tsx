...
export const RequestAccessBanner: React.FC<RequestAccessBannerProps> = ({ onRequestAccess }) => {
  return (
    <View className="bg-[#D97706]/15 rounded-[10px] p-4 border border-[#D97706]/30">
      <View className="flex-row items-center gap-3">
        ...
        >
          <Text className="text-[15px] font-semibold text-white">Request Access</Text>
        </TouchableOpacity>
      </View>
    </View>
  );

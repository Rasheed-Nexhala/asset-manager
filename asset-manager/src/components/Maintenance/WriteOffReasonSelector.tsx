...
import { WriteOffReason, WriteOffReasonConfig } from '../../types/maintenance';
...
// Write-off reason configurations
...
export default function WriteOffReasonSelector({
  value,
  onSelect,
  error,
  disabled = false,
  ...
  const selectedConfig = writeOffReasons.find((reason) => reason.value === value);
  ...
  return (
    <>
      ...
      <TouchableOpacity
        ...
        disabled={disabled}
        accessibilityLabel="Write-off reason selector"
        accessibilityHint="Select the reason for write-off"

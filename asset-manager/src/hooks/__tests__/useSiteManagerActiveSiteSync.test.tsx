...
jest.mock('../../utils/activeManagedSiteStorage', () => ({
  loadActiveManagedSiteId: jest.fn(),
  saveActiveManagedSiteId: jest.fn(),
}));
...
} = require('../../utils/activeManagedSiteStorage') as {
  loadActiveManagedSiteId: jest.Mock;
  saveActiveManagedSiteId: jest.Mock;
};
...
describe('useSiteManagerActiveSiteSync', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    loadActiveManagedSiteId.mockResolvedValue(null);
    saveActiveManagedSiteId.mockResolvedValue(undefined);
  });
  ...
  it('loads stored active id when it is still a managed site', async () => {
    loadActiveManagedSiteId.mockResolvedValue('site-b');

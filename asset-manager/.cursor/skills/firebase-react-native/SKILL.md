...
Always unsubscribe from real-time listeners to prevent:
- Memory leaks
- Unexpected re-renders
- Stale data updates after component unmount
...
Import Firebase types for better type safety:
...
Firebase Web SDK includes automatic offline persistence:
- Firestore: Enabled by default
- Auth: Tokens cached locally
- Storage: No automatic caching (implement manually if needed)
...
For complete API documentation, see [FIREBASE_API.md](FIREBASE_API.md)
For real-world usage examples, see [asset-manager/config/FIREBASE_USAGE.md](../asset-manager/config/FIREBASE_USAGE.md)

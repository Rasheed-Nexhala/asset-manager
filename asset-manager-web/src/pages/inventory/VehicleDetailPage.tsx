    ...
    <div className="flex min-h-0 flex-1 flex-col bg-slate-50">
      ...
      {isSiteManager && !canManage && (
        <div className="shrink-0 border-b border-slate-200 bg-amber-600/10">
          <div className="mx-auto max-w-6xl px-4 py-2 text-[13px] text-slate-700 md:px-6 lg:px-8">
            Site Manager view — dispense fuel from transferred requests on each request. Central store fuel assignment
            is done by Store Incharge only.
          </div>
        </div>
      )}

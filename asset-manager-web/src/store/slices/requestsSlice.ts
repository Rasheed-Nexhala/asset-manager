...
const requestsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    // Queue pagination
    builder
      .addCase(fetchRequestsPaginated.pending, (state) => {
        state.loading = true;
      })
      .addCase(fetchRequestsPaginated.fulfilled, (state, action) => {
      ...
      .addCase(fetchRequestsPaginated.rejected, (state) => {
        state.loading = false;
        state.requests = [];
      ...
      .addCase(loadMoreRequests.pending, (state) => {
        state.requestsLoadingMore = true;
      })
      .addCase(loadMoreRequests.fulfilled, (state, action) => {
        state.requests = [...state.requests, ...action.payload.requests];
        state.requestsLastDoc = action.payload.lastDoc;
        state.requestsHasMore = action.payload.requests.length >= REQUESTS_PAGE_SIZE;
        state.requestsLoadingMore = false;
      })
      .addCase(loadMoreRequests.rejected, (state) => {
        state.requestsLoadingMore = false;
      })
      // My requests pagination
      .addCase(fetchMyRequestsPaginated.pending, (state) => {
        state.loading = true;
      })
      .addCase(fetchMyRequestsPaginated.fulfilled, (state, action) => {
      ...
      .addCase(fetchMyRequestsPaginated.rejected, (state) => {
        state.loading = false;
        state.myRequests = [];
      ...
      .addCase(loadMoreMyRequests.pending, (state) => {
        state.myRequestsLoadingMore = true;
      })
      .addCase(loadMoreMyRequests.fulfilled, (state, action) => {
        state.myRequests = [...state.myRequests, ...action.payload.requests];
        state.myRequestsLastDoc = action.payload.lastDoc;
        state.myRequestsHasMore = action.payload.requests.length >= REQUESTS_PAGE_SIZE;
        state.myRequestsLoadingMore = false;
      })
      .addCase(loadMoreMyRequests.rejected, (state) => {
        state.myRequestsLoadingMore = false;
      });
  },
});

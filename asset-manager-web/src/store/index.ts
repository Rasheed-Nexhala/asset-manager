    ...
    getDefaultMiddleware({
      serializableCheck: {
        ignoredActions: [
          ...
          'inventoryUpdateRequest/createRequest/fulfilled',
          'inventoryUpdateRequest/approveRequest/fulfilled',
          'inventoryUpdateRequest/rejectRequest/fulfilled',
        ],
        ignoredPaths: [
          'auth.user',
          'sites.sites',
          ...
          'inventoryUpdateRequest.myWriteOffAccessGrantedUntil',
        ],
      },
    }),
});

      ...
      {isOpen && (
        <>
          <div
            ...
            aria-hidden
          />
          <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-[10px] border border-slate-200 shadow-lg z-50 max-h-80 overflow-hidden flex flex-col">

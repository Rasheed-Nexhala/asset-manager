...
export interface PurchaseOrderItem {
  ...
  // Mobile app compatibility fields (from React Native receive flow)
  /** Unit price captured during mobile receive (may differ from unitPrice) */
  receivedUnitPrice?: number | null;
  /** Total amount for received quantity at received price (mobile app) */
